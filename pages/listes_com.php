...
$requette = 'SELECT * FROM commande INNER JOIN client ON commande.NUM_CLIENT = client.NUM_CLIENT';
      ...
      <tbody class="text-black">
        ...
        <?php foreach ($commands as $command) : ?>
          <tr class="text-center">
            <td scope="row"><?= $command->NUMCOM ?></td>
            <td><?= $command->NOMCLIENT ?></td>
            <td><?= $command->TOTALE ?></td>
            <td><?= $command->DATECOM ?></td>
            <td class="text-right">
